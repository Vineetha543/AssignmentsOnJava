...
public class AllMethodsFromReflectionAPI {

	public static void main(String[] args) {

		try {

			Class<?> myClass = Class.forName(Demo.class.getName());
			...
			Method method3 = myClass.getMethod("sum", int.class, int.class);
			System.out.println(method3.invoke(myObj, 3, 7));
